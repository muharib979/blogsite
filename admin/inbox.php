                ...
                ?>
						<tr class="odd gradeX">
							...
							<td>
							     ...
							     <a href="replymsg.php?msgid=<?php echo $result['id']; ?>">Replay</a> ||
        ...
        ?>
                ...
                ?>
						<tr class="odd gradeX">
							...
							<td>
							<a href="viewmsg.php?msgid=<?php echo $result['id']; ?>">View</a> ||
							     <a onclick="return confirm('Are you sure to Deleted!'); " href="?delid=<?php echo $result['id']; ?>">Delete</a> ||
							     <a onclick="return confirm('Are you sure to Move the Msg at inbox!'); " href="?unseenid=<?php echo $result['id']; ?>">UnSeen</a>
